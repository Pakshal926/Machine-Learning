...
SEQ_LENGTH = 60  # Increased sequence length for more context
STEP_SIZE = 3
...
model = Sequential([
    LSTM(256, input_shape=(SEQ_LENGTH, len(characters)), return_sequences=True),
    Dropout(0.2),
    LSTM(256),
    Dropout(0.2),
...
# Train the model
model.fit(x, y, batch_size=256, epochs=10)  # Train for more epochs for better coherence
...
# Generate and print text at different temperatures
